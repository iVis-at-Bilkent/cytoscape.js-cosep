(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cytoscapeCosepPort"] = factory(require("cose-base"));
	else
		root["cytoscapeCosepPort"] = factory(root["coseBase"]);
...
var register = function register(cytoscape) {
  ...
  cytoscape('layout', 'coseport', impl); // register with cytoscape.js
};
...
var Layout = function (_ContinuousLayout) {
  ...
  _createClass(Layout, [{
    ...
    value: function prerun() {
      ...
      this.state.maxIterations = 1; // Does this even matter?
    }
